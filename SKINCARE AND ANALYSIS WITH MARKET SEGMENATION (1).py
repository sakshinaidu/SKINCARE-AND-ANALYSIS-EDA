...
#User Growth Forecast (Line Graph)
import matplotlib.pyplot as plt

years = [1, 2, 3, 4, 5]
users = [1000 * (1.1 ** i) for i in range(len(years))]

plt.figure(figsize=(10, 6))
plt.plot(years, users, marker='o', color='blue')
plt.title("Active User Growth Forecast")
plt.xlabel("Years")
...
revenue = [15000, 16000, 17600, 19360, 21396]
profit = [10000, 11000, 12600, 14360, 16396]

plt.figure(figsize=(10, 6))
plt.bar(years, revenue, alpha=0.7, label='Revenue', color='green')
plt.bar(years, profit, alpha=0.7, label='Profit', color='orange')
plt.title("Revenue and Profit Forecast")
plt.xlabel("Years")
